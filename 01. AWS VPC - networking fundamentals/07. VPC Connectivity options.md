...
![07_VPC_01](../Images/07.01_VPC_connections.png)

Hay mucho servicios que pueden acceder como api gateway, sqs que necesitan una interface de vpc enpoint que se llama esa conexión private link
![07_VPC_01](../Images/07.02_VPC_connections.png)

Si tienes una aplicación saas y quieres acceder a estos recursos, tambien se puede por un PrivateLink
![07_VPC_01](../Images/07.03_VPC_connections.png)
...
![07_VPC_01](../Images/07.04_VPC_connections.png)
Sin embargo esa comunicación es una a una, las vpc que no están interconectadas no se pueden comunicar entre sí .
...
![07_VPC_01](../Images/07.06_VPC_connections.png)

Por lo que es mejor usar un transit Gateway
![07_VPC_01](../Images/07.07_VPC_connections.png)
...
![07_VPC_01](../Images/07.08_VPC_connections.png)
...
![07_VPC_01](../Images/07.09_VPC_connections.png)
para emparejas las Vpcs
